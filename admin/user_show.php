                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <!-- <a href="?act=edit&update_id=<?php echo $result_user['user_id'] ?>" type="button" class="btn btn-warning">แก้ไข</a> -->
                                <a href="?delete_id=<?php echo $result_user['user_id'] ?>" onclick="return confirm('ยืนยันการลบ');" type="button" class="btn btn-danger">ลบ</a>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
