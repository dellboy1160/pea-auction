...
if (isset($_REQUEST['btn_submit'])) {
    ...
    if ($num != 0) {
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            header('refresh:2;admin/main_page.php');
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-3 mb-5 bg-body rounded" style="margin-top: 50px;">
                    <div class="card-body">
                        <div class="col-md-12">
                            <h3 class="text-center ">เข้าสู่ระบบ <strong>Admin</strong> </h3>
                        </div>
                        <?php
                        if (isset($errorMsg)) { ?>
                        ...
                        <form action="" class="row g-3 needs-validation" method="POST" novalidate>
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" name="txt_username" id="validationCustomUsername" value="<?php if (isset($username)) {
                                                                                                                                            echo $username;
                                                                                                                                        } ?>" placeholder="ชื่อผู้ใช้" aria-describedby="inputGroupPrepend" required>
                            ...
                            <div class="col-md-12 text-center mt-2">
                                <a href="index.php" class="text-center">กลับหน้า User</a>
                            </div>
